...
public class Q1 implements QueryPlanGenerator {
  ...
  public Map<Integer, RootOperator[]> getWorkerPlan(final int[] allWorkers) throws Exception {
    ...
    final DbQueryScan allJournals = new DbQueryScan(
        ...
        subjectSchema);
    final DbQueryScan allWithTheTitle = new DbQueryScan(
    ...
    final DbQueryScan allIssuedYear = new DbQueryScan(
    ...
    final GenericShuffleProducer shuffleJournalsP = new GenericShuffleProducer(allJournals, allJournalsShuffleID,
        allWorkers, pf);
    final GenericShuffleConsumer shuffleJournalsC = new GenericShuffleConsumer(shuffleJournalsP.getSchema(),
        allJournalsShuffleID, allWorkers);

    final GenericShuffleProducer shuffleWithTitleP = new GenericShuffleProducer(allWithTheTitle, allWithTitleShuffleID,
        allWorkers, pf);
    final GenericShuffleConsumer shuffleWithTitleC = new GenericShuffleConsumer(shuffleWithTitleP.getSchema(),
        allWithTitleShuffleID, allWorkers);

    final GenericShuffleProducer shuffleIssuedYearP = new GenericShuffleProducer(allIssuedYear, allIssuedYearShuffleID,
        allWorkers, pf);
    final GenericShuffleConsumer shuffleIssuedYearC = new GenericShuffleConsumer(shuffleIssuedYearP.getSchema(),
        allIssuedYearShuffleID, allWorkers);

    final SymmetricHashJoin joinJournalTitle = new SymmetricHashJoin(shuffleJournalsC, shuffleWithTitleC, new int[] {
        0 }, new int[] { 0 });

    final SymmetricHashJoin joinJournalTitleYear = new SymmetricHashJoin(joinJournalTitle, shuffleIssuedYearC,
        new int[] { 0 }, new int[] { 0 });
