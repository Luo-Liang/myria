...
public class AggregateTest
{
    ...
    public TupleBatchBuffer generateRandomIntegerTuples(final int numTuples)
    {
        final String[] names = TestUtils.randomFixedLengthNumericString(1000, 1005, numTuples, 20);
        final int[] ids = TestUtils.randomInt(1, numTuples, names.length);

        final Schema schema =
                new Schema(
                        ImmutableList.of(Type.INT_TYPE, Type.INT_TYPE), ImmutableList.of("id", "name"));
    ...
    public void testSingleGroupCountSketchMin() throws DbException, InterruptedException
    {
        ...
        agg.open(new HashMap<String, Object>(){
            {
